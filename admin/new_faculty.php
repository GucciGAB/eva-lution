                                    ...
                                    <div id="subjects-container">
                                        ...
                                        if (!empty($subjects)) {
                                            ...
                                            <div class="input-group mb-3 subject-item">
                                                <input type="text" class="form-control" name="subjects[]" required placeholder="subject code (cc101)" value="' . htmlspecialchars(trim($subject), ENT_QUOTES) . '">
                                            ...
                                            echo '
                                        <div class="input-group mb-3 subject-item">
                                            <input type="text" class="form-control" name="subjects[]" required placeholder="subject code (cc101)">
                                            <div class="input-group-append">
